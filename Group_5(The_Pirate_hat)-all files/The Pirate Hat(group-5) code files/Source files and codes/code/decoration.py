...
class Sky:
	def __init__(self,horizon,style = 'level'):   # Importing the images of top,middle and bottom sky
		self.top = pygame.image.load('../graphics/decoration/sky/sky_top.png').convert()
		self.bottom = pygame.image.load('../graphics/decoration/sky/sky_bottom.png').convert()
		self.middle = pygame.image.load('../graphics/decoration/sky/sky_middle.png').convert()
		self.horizon = horizon

		# stretch  the imported background pictures
		...
		if self.style == 'overworld':
			...
			cloud_surfaces = import_folder('../graphics/overworld/clouds')  # importing cloudsets
			self.clouds = []
...
class Water:
	def __init__(self,top,level_width):
		...
		for tile in range(tile_x_amount):             # adding water in the bottom
